private ["_random","_lastIndex","_index","_vehicle","_velimit","_qty","_isAir","_isShip","_position","_dir","_istoomany","_veh","_objPosition","_iClass","_num","_allCfgLoots","_pos"];
...
if (count AllowedVehiclesList == 0) then {
	...
	if (_isShip or _isAir) then {
		if (_isShip) then {
			...
			_position = [getMarkerPos "center",0,13000,2,0,0.065,0] call BIS_fnc_findSafePos;
