...
if (!isDedicated) then {
	...
	Fix_echap = {
		...
		_echap = (findDisplay 49) displayCtrl 104;
		_echap ctrlSetText "Quit";
		_echap ctrlSetPosition [0.051,0.661312,0.313726,0.104575];
		_echap ctrlCommit 0;	
		buttonSetAction [104,"[] execVM '\z\addons\dayz_code\compile\player_onPause.sqf';"];	
	};
